...
//	func didFinishSongServiceSelectionWith(_ model: TempClustersModel, completion: (() -> Void))
//}
//
//class NewSongServiceController: ChurchBeamViewController, SongsControllerDelegate, UITableViewDelegate, UITableViewDataSource, UIGestureRecognizerDelegate {
//
//
...
//		return "NewSongServiceController"
//	}
...
//
//	private var model: TempClustersModel? = nil
//
//
//
...
//		return model?.songServiceSettings?.sections.count ?? 1
//	}
//
...
//		}
////		delegate?.didFinishSongServiceSelection(clusters: selectedClusters, songServiceSettings: songServiceSettings, songsPerSection: nil, songsPerSectionWithComments: <#[[Any]]#>, completion: {
