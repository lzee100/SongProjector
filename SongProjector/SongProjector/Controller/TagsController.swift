...
//import UIKit
//
//class TagsController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate, UIGestureRecognizerDelegate, NewOrEditIphoneControllerDelegate {
//
//
...
//		if let newTagController = segue.destination as? NewOrEditIphoneController {
