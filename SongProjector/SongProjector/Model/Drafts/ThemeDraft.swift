...
class ThemeDraft {
    ...
    enum UpdateProperties {
        ...
        case backgroundTransparancyNumber(Double)
        case displayTime(Bool)
        case hasEmptySheet(Bool)
        case imagePath(String?)
        case imagePathThumbnail(String?)
        case isEmptySheetFirst(Bool)
        case isHidden(Bool)
        case isContentBold(Bool)
        case isContentItalic(Bool)
        case isContentUnderlined(Bool)
        case isTitleBold(Bool)
        case isTitleItalic(Bool)
        case isTitleUnderlined(Bool)
        case contentAlignmentNumber(Int16)
        case contentBorderColorHex(String?)
        case contentBorderSize(Float)
        case contentFontName(String?)
        case contentTextColorHex(String?)
        case contentTextSize(Float)
        case position(Int16)
        case titleAlignmentNumber(Int16)
        case titleBackgroundColor(String?)
        case titleBorderColorHex(String?)
        case titleBorderSize(Float)
        case titleFontName(String?)
        case titleTextColorHex(String?)
        case titleTextSize(Float)
        case imagePathAWS(String?)
        case isUniversal(Bool)
        case isDeletable(Bool)
    ...
    private(set) var backgroundTransparancyNumber: Double = 0
    ...
    var imageSelectionAction: ImageSelectionAction = .none
    ...
    var themeCodable: ThemeCodable {
        ...
        case .none, .image:
            ...
            imagePathThumbnail = self.imagePathThumbnail
        }
