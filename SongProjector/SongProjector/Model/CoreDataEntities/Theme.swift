...
extension Theme {
    ...
    var vTheme: VTheme {
        VTheme(id: id, userUID: userUID, title: title, createdAt: createdAt, updatedAt: updatedAt, deleteDate: deleteDate, rootDeleteDate: rootDeleteDate as Date?, allHaveTitle: allHaveTitle, backgroundColor: backgroundColor, backgroundTransparancyNumber: backgroundTransparancyNumber, displayTime: displayTime, hasEmptySheet: hasEmptySheet, imagePath: imagePath, imagePathThumbnail: imagePathThumbnail, isEmptySheetFirst: isEmptySheetFirst, isHidden: isHidden, isContentBold: isContentBold, isContentItalic: isContentItalic, isContentUnderlined: isContentUnderlined, isTitleBold: isTitleBold, isTitleItalic: isTitleItalic, isTitleUnderlined: isTitleUnderlined, contentAlignmentNumber: contentAlignmentNumber, contentBorderColorHex: contentBorderColorHex, contentBorderSize: contentBorderSize, contentFontName: contentFontName, contentTextColorHex: contentTextColorHex, contentTextSize: contentTextSize, position: position, titleAlignmentNumber: titleAlignmentNumber, titleBackgroundColor: titleBackgroundColor, titleBorderColorHex: titleBorderColorHex, titleBorderSize: titleBorderSize, titleFontName: titleFontName, titleTextColorHex: titleTextColorHex, titleTextSize: titleTextSize, imagePathAWS: imagePathAWS, isUniversal: isUniversal, isDeletable: isDeletable)
    }
}
