...
//	}
	...
	@NSManaged public var hasCluster: NSSet?
	...
	public override func copy(with zone: NSZone? = nil) -> Any {
		let entity = CoreTag.createEntityNOTsave()
...
// MARK: Generated accessors for hasCluster
extension Tag {
	
	@objc(addHasClusterObject:)
	@NSManaged public func addToHasCluster(_ value: Cluster)
	
	@objc(removeHasClusterObject:)
	@NSManaged public func removeFromHasCluster(_ value: Cluster)
	
	@objc(addHasCluster:)
	@NSManaged public func addToHasCluster(_ values: NSSet)
	
	@objc(removeHasCluster:)
	@NSManaged public func removeFromHasCluster(_ values: NSSet)
