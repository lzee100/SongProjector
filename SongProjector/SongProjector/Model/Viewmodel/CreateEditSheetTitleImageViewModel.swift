//
//  CreateEditSheetTitleImageViewModel.swift
//  SongProjector
//
...
class CreateEditSheetTitleImageViewModel: CreateEditThemeSheetViewModelProtocol {
    ...
    private let sections: [NewOrEditIphoneController.Section]  = [.input, .general, .title, .content, .image]
